...
This system is a cyberpunk-blue system that you can use as a starting point for building your own custom systems. It's similar to Simple World-building, but has examples of creating attributes in code rather than dynamically through the UI.

## Usage

There are two ways to get started: using the CyberBlue system generator command or manually renaming and updating files.
...
> **Python Generator**
> 
> If you would rather use Python than node, thereâ€™s an excellent Python-based generator created by Cussa at https://github.com/Cussa/fvtt-cyberpunk-blue-initializator. Give it a shot!
...
Before installing this system, you should rename any files that have `cyberpunk-blue` in their filename to use whatever machine-safe name your system needs, such as `adnd2e` if you were building a system for 2nd edition Advanced Dungeons & Dragons. In addition, you should search through the files for `cyberpunk-blue` and `CyberBlue` and do the same for those, replacing them with appropriate names for your system.
...
Head over to the [Vue3CyberBlue System](https://gitlab.com/asacolips-projects/foundry-mods/vue3cyberpunk-blue) repo if you're interested in using Vue!
...
![image](http://mattsmith.in/images/cyberpunk-blue.png)
