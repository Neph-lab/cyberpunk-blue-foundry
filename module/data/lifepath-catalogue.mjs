...
export const LIFEPATH_CATALOGUE = [
  ...
  // Enemies / Hairstyle and should not be shown as standalone entries in the wizard.
  //
  // Document-type results use compendium UUIDs so the chains work both from the
  // compendium directly and after import to a world.

  {
    _id: 'GenLp01000000000',
    name: 'Cultural Origins',
    img: 'modules/game-icons-net/whitetransparent/wireframe-globe.svg',
    description: "Your cultural origins might show you're an immigrant to Night City or just show where your family came from before they settled there. Your choice.",
    _folder: 'General Lifepath',
    formula: '2d6',
    results: [
      { range: [2,  2],  text: 'Middle-Eastern / North African', type: 'text' },
      { range: [3,  3],  text: 'Sub-Saharan African',            type: 'text' },
      { range: [4,  4],  text: 'South American',                 type: 'text' },
      { range: [5,  5],  text: 'Western European',               type: 'text' },
      { range: [6,  6],  text: 'Eastern European',               type: 'text' },
      { range: [7,  7],  text: 'North American',                 type: 'text' },
      { range: [8,  8],  text: 'Central American',               type: 'text' },
      { range: [9,  9],  text: 'South-East Asian',               type: 'text' },
      { range: [10, 10], text: 'East Asian',                     type: 'text' },
      { range: [11, 11], text: 'South Asian',                    type: 'text' },
      { range: [12, 12], text: 'Pacific Icelander',              type: 'text' },
    ],
  },

  {
    ...
    img: 'modules/game-icons-net/whitetransparent/family-tree.svg',
    _folder: 'General Lifepath',
    formula: '1d10',
    results: [
      { range: [1,  1],  text: 'Your family were Corpo executives. Wealthy, powerful, with servants and luxury homes. How did you end up edgerunning?', type: 'text' },
      { range: [2,  2],  text: 'Your family were Corpo managers. Middle management still meant a decent home and a safe life. Looks like you didn\'t follow in their footsteps.', type: 'text' },
      { range: [3,  3],  text: 'Your family were Corporate workers. Long hours and harsh working conditions meant you rarely saw your guardian(s) but at least you had a roof over your head and food in your belly.', type: 'text' },
      { range: [4,  4],  text: 'Your family were a nomad pack. You grew up on the road, living in trailers and tents. You learned to drive and fight at an early age but your family was always there to care for you.', type: 'text' },
      { range: [5,  5],  text: 'Your family were gangers. Depending on the gang, you were either part of the family or a resource to be exploited. Either way, it was a rough life.', type: 'text' },
      { range: [6,  6],  text: 'Your family were combat zoners. You grew up in a place completely abandoned by the rest of society, like Pacifica. Life was a constant struggle.', type: 'text' },
      { range: [7,  7],  text: 'Your family were urban homeless. You lived in shanty towns, tent villages, abandoned shipping containers, and wherever else you could. Since you\'re still alive, you obviously learned how to survive.', type: 'text' },
      { range: [8,  8],  text: 'Your family were megabuilding residents. Like so many kids, you grew up in one of the megabuildings. Probably not the top floors, either. A small apartment and two meals of scop a day.', type: 'text' },
      { range: [9,  9],  text: 'Your family were edgerunners. Your home always changed depending on the employment of the person or persons taking care of you. A luxury apartment one day, the back of someone\'s car the next. Now you\'re following in their footsteps.', type: 'text' },
      { range: [10, 10], text: 'Your family were among everyone else. Not everyone fits neatly into one of the above categories. You could be the kid of shopkeepers, cab drivers, joytoys, or any of a thousand others.', type: 'text' },
    ],
  },

  {
    ...
    img: 'modules/game-icons-net/whitetransparent/road.svg',
    _folder: 'General Lifepath',
    formula: '1d6',
    results: [
      { range: [1, 1], text: 'As a child you ran the streets with little adult supervision.', type: 'text' },
      { range: [2, 2], text: 'As a child you lived in a mansion, high up a skyscraper, or other safe place.', type: 'text' },
      { range: [3, 3], text: 'You lived with a nomad pack as a child, moving from place to place.', type: 'text' },
      { range: [4, 4], text: 'You lived in the heart of a combat zone as a child, staying in a wrecked building or squat.', type: 'text' },
      { range: [5, 5], text: 'You grew up in a megabuilding owned by a megacorp or the government.', type: 'text' },
      { range: [6, 6], text: 'You grew up in an average, small dwelling, like the houses in Rancho Coronado or an apartment in the city.', type: 'text' },
    ],
  },

  {
    ...
    name: 'Your Crisis',
    img: 'modules/game-icons-net/whitetransparent/burning-round-shot.svg',
    description: 'No one becomes an Edgerunner without having suffered some tragedy.',
    _folder: 'General Lifepath',
    formula: '1d6',
    results: [
      { range: [1, 1], text: 'Someone betrayed you or your family. You lost everything.', type: 'text' },
      { range: [2, 2], text: 'You or your family were exiled or driven from their original home by circumstances or politics.', type: 'text' },
      { range: [3, 3], text: "You're all that remains of your family. The rest died or vanished.", type: 'text' },
      { range: [4, 4], text: "You've inherited a feud, either by your actions or your heritage.", type: 'text' },
      { range: [5, 5], text: "You're in debt, either because of your actions or your family's.", type: 'text' },
      { range: [6, 6], text: "You're wanted by the law. Maybe you did it. Maybe you didn't. Either way, be careful.", type: 'text' },
    ],
  },

  {
    ...
    name: 'Personality',
    img: 'modules/game-icons-net/whitetransparent/double-face-mask.svg',
    description: 'What are you like as a person?',
    _folder: 'General Lifepath',
    formula: '1d10',
    results: [
      { range: [1,  1],  text: "You're shy and secretive.",              type: 'text' },
      { range: [2,  2],  text: "You're rebellious, anti-social and violent.", type: 'text' },
      { range: [3,  3],  text: "You're arrogant, proud, and aloof.",     type: 'text' },
      { range: [4,  4],  text: "You're moody, rash, and headstrong.",    type: 'text' },
      { range: [5,  5],  text: "You're picky, fussy, and nervous.",      type: 'text' },
      { range: [6,  6],  text: "You're stable and serious.",             type: 'text' },
      { range: [7,  7],  text: "You're silly and fluff-headed.",         type: 'text' },
      { range: [8,  8],  text: "You're sneaky and deceptive.",           type: 'text' },
      { range: [9,  9],  text: "You're intellectual and detached.",      type: 'text' },
      { range: [10, 10], text: "You're friendly and outgoing.",          type: 'text' },
    ],
  },

  {
    ...
    img: 'modules/game-icons-net/whitetransparent/overdrive.svg',
    _folder: 'General Lifepath',
    formula: '1d10',
    results: [
      { range: [1,  1],  text: 'You value money.',      type: 'text' },
      { range: [2,  2],  text: 'You value honor.',      type: 'text' },
      { range: [3,  3],  text: 'You value your word.',  type: 'text' },
      { range: [4,  4],  text: 'You value honesty.',    type: 'text' },
      { range: [5,  5],  text: 'You value knowledge.',  type: 'text' },
      { range: [6,  6],  text: 'You value vengeance.',  type: 'text' },
      { range: [7,  7],  text: 'You value love greatly.', type: 'text' },
      { range: [8,  8],  text: 'You value power.',      type: 'text' },
      { range: [9,  9],  text: 'You value family.',     type: 'text' },
      { range: [10, 10], text: 'You value friendship.', type: 'text' },
    ],
  },

  {
    ...
    results: [
      ...
      { range: [5,  5],  text: 'People are obstacles in your way.',         type: 'text' },
      { range: [6,  6],  text: 'Everyone is unique — judge accordingly.',   type: 'text' },
      { range: [7,  7],  text: 'Most people are trash — judge accordingly.', type: 'text' },
      { range: [8,  8],  text: 'Forming deep connections is hard.',         type: 'text' },
      { range: [9,  9],  text: 'You fall in love too quickly.',             type: 'text' },
      { range: [10, 10], text: 'All life has meaning — cherish it.',        type: 'text' },
    ],
  },

  {
    ...
    name: 'Life Goal',
    img: 'modules/game-icons-net/whitetransparent/stairs-goal.svg',
    _folder: 'General Lifepath',
    formula: '1d6',
    results: [
      { range: [1, 1], text: 'You need to fix a mistake you made.',                          type: 'text' },
      { range: [2, 2], text: 'You want power and control.',                                   type: 'text' },
      { range: [3, 3], text: "You're looking to score big and get out of the game.",          type: 'text' },
      { range: [4, 4], text: "There's shame in your past, and you want to correct it.",      type: 'text' },
      { range: [5, 5], text: 'Fame and money, choomba!',                                      type: 'text' },
      { range: [6, 6], text: 'Protect the people you love in any way you can.',              type: 'text' },
    ],
  },

  {
    ...
    name: 'Wardrobe Style',
    img: 'modules/game-icons-net/whitetransparent/clothes.svg',
    _folder: 'General Lifepath',
    formula: '1d6',
    results: [
...

  {
    ...
    name: 'Hairstyle',
    img: 'modules/game-icons-net/whitetransparent/hair-strands.svg',
    _folder: 'General Lifepath',
    formula: '1d6',
    // Each result also triggers the Hair color sub-table (except bald).
    results: [
      { range: [1, 1], text: 'Classic Mohawk',        type: 'text' },
      { range: [1, 1], type: 'document', documentUuid: 'Compendium.cyberpunk-blue.lifepath-tables.RollTable.GenLp11000000000', text: 'Hair color' },
      { range: [2, 2], text: 'Short and Styled',      type: 'text' },
      { range: [2, 2], type: 'document', documentUuid: 'Compendium.cyberpunk-blue.lifepath-tables.RollTable.GenLp11000000000', text: 'Hair color' },
      { range: [3, 3], text: 'Short and Unkempt',     type: 'text' },
      { range: [3, 3], type: 'document', documentUuid: 'Compendium.cyberpunk-blue.lifepath-tables.RollTable.GenLp11000000000', text: 'Hair color' },
      { range: [4, 4], text: 'Shaved close or Bald',  type: 'text' },
      { range: [5, 5], text: 'Long and Styled',       type: 'text' },
      { range: [5, 5], type: 'document', documentUuid: 'Compendium.cyberpunk-blue.lifepath-tables.RollTable.GenLp11000000000', text: 'Hair color' },
      { range: [6, 6], text: 'Long and Unkempt',      type: 'text' },
      { range: [6, 6], type: 'document', documentUuid: 'Compendium.cyberpunk-blue.lifepath-tables.RollTable.GenLp11000000000', text: 'Hair color' },
    ],
  },

  {
    ...
    formula: '1d6',
    results: [
      { range: [1, 1], text: 'Multi-Hued',               type: 'text' },
      { range: [2, 2], text: 'One Bright Color',          type: 'text' },
      { range: [3, 3], text: 'Natural Color',             type: 'text' },
      { range: [4, 4], text: 'Subtly Shaded',             type: 'text' },
      { range: [5, 5], text: 'Festooned with Decorations', type: 'text' },
      { range: [6, 6], text: 'Different Every Day',       type: 'text' },
    ],
  },

  {
    ...
    name: 'Friends',
    img: 'modules/game-icons-net/whitetransparent/three-friends.svg',
    _folder: 'General Lifepath',
    formula: '1d6',
    // Results 2–6 also trigger "Who's your friend?". On a 6, it triggers twice (two friends).
    results: [
      { range: [1, 1], text: 'You have no close friends.',    type: 'text' },
      { range: [2, 5], text: 'You have a close friend.',      type: 'text', weight: 4 },
      { range: [6, 6], text: 'You have two close friends.',   type: 'text' },
      { range: [2, 6], type: 'document', documentUuid: 'Compendium.cyberpunk-blue.lifepath-tables.RollTable.GenLp15000000000', text: "Who's your friend?" },
      { range: [6, 6], type: 'document', documentUuid: 'Compendium.cyberpunk-blue.lifepath-tables.RollTable.GenLp15000000000', text: "Who's your friend?" },
    ],
  },

  {
    ...
    name: 'Enemies',
    img: 'modules/game-icons-net/whitetransparent/daemon-skull.svg',
    _folder: 'General Lifepath',
    formula: '1d6',
    // Results 2–6 also trigger "Who's your enemy?". On a 6, it triggers twice (two enemies).
    results: [
      { range: [1, 1], text: 'You have no significant enemies.', type: 'text' },
      { range: [2, 5], text: 'You have an enemy.',               type: 'text', weight: 4 },
      { range: [6, 6], text: 'You have two enemies.',            type: 'text' },
      { range: [2, 6], type: 'document', documentUuid: 'Compendium.cyberpunk-blue.lifepath-tables.RollTable.GenLp16000000000', text: "Who's your enemy?" },
      { range: [6, 6], type: 'document', documentUuid: 'Compendium.cyberpunk-blue.lifepath-tables.RollTable.GenLp16000000000', text: "Who's your enemy?" },
    ],
  },

  {
    ...
    img: 'modules/game-icons-net/whitetransparent/shattered-heart.svg',
    _folder: 'General Lifepath',
    formula: '1d6',
    results: [
      { range: [1, 1], text: 'Your lover died — either through accident or murder.',                              type: 'text' },
      { range: [2, 2], text: 'Your lover mysteriously vanished.',                                                  type: 'text' },
      { range: [3, 3], text: 'A personal goal or vendetta came between you and your lover.',                      type: 'text' },
      { range: [4, 4], text: 'Your lover was imprisoned or exiled.',                                              type: 'text' },
      { range: [5, 5], text: 'Your lover left you for someone else.',                                             type: 'text' },
      { range: [6, 6], text: "No lover comes to mind. Are you unlucky, not into that, or something else?",       type: 'text' },
    ],
  },

  // ── Sub-tables (triggered automatically — not shown as standalone entries in the wizard) ─

  {
    ...
    _subTable: true,
    formula: '1d6',
    // Always also triggers "What's their Role?" for all results.
    results: [
      { range: [1, 1], text: "An ex-lover you're on good terms with",          type: 'text' },
      { range: [2, 2], text: 'Someone you grew up with',                        type: 'text' },
      { range: [3, 3], text: 'A mentor or parental figure',                     type: 'text' },
      { range: [4, 4], text: 'A former boss who remembers you fondly',          type: 'text' },
      { range: [5, 5], text: "An old enemy/rival you've made peace with",       type: 'text' },
      { range: [6, 6], text: 'Someone you share a hobby and geek out with',     type: 'text' },
      { range: [1, 6], type: 'document', documentUuid: 'Compendium.cyberpunk-blue.lifepath-tables.RollTable.GenLp17000000000', text: "What's their Role?" },
    ],
  },

  {
    ...
    // Always also triggers "What's their Role?" for all results.
    results: [
      { range: [1, 1], text: 'A former friend or lover',                                      type: 'text' },
      { range: [2, 2], text: 'An enemy from your childhood',                                  type: 'text' },
      { range: [3, 3], text: 'An old boss who betrayed you',                                  type: 'text' },
      { range: [4, 4], text: 'One of your relatives',                                         type: 'text' },
      { range: [5, 5], text: 'A former partner or coworker',                                  type: 'text' },
      { range: [6, 6], text: "A mysterious figure. You don't even know they exist.",          type: 'text' },
      { range: [1, 6], type: 'document', documentUuid: 'Compendium.cyberpunk-blue.lifepath-tables.RollTable.GenLp17000000000', text: "What's their Role?" },
    ],
  },

  {
    ...
    img: 'modules/game-icons-net/whitetransparent/abstract-007.svg',
    _folder: 'General Lifepath',
    _subTable: true,
    formula: '1d18',
    // Always also triggers "How big is their Circle?" for all results.
    results: [
      { range: [1,  4],  text: 'No Role applies', type: 'text', weight: 4 },
      { range: [5,  5],  text: 'Bandit',    type: 'text' },
      { range: [6,  6],  text: 'Corpo',     type: 'text' },
      { range: [7,  7],  text: 'Fixer',     type: 'text' },
      { range: [8,  8],  text: 'Guide',     type: 'text' },
      { range: [9,  9],  text: 'Law',       type: 'text' },
      { range: [10, 10], text: 'Media',     type: 'text' },
      { range: [11, 11], text: 'Medtech',   type: 'text' },
      { range: [12, 12], text: 'Netrunner', type: 'text' },
      { range: [13, 13], text: 'Ninja',     type: 'text' },
      { range: [14, 14], text: 'Nomad',     type: 'text' },
      { range: [15, 15], text: 'Operative', type: 'text' },
      { range: [16, 16], text: 'Rocker',    type: 'text' },
      { range: [17, 17], text: 'Solo',      type: 'text' },
      { range: [18, 18], text: 'Techie',    type: 'text' },
      { range: [1, 18],  type: 'document', documentUuid: 'Compendium.cyberpunk-blue.lifepath-tables.RollTable.GenLp18000000000', text: 'How big is their Circle?' },
    ],
  },

  {
    ...
    img: 'modules/game-icons-net/whitetransparent/circular-sawblade.svg',
    _folder: 'General Lifepath',
    _subTable: true,
    formula: '1d10',
    results: [
      { range: [1,  1],  text: "They're a combat zone resident",                    type: 'text' },
      { range: [2,  2],  text: "They're a corporate ladder climber",                type: 'text' },
      { range: [3,  3],  text: 'They have an Edgerunning crew',                     type: 'text' },
      { range: [4,  4],  text: 'They have emergency response / medical personnel',  type: 'text' },
      { range: [5,  5],  text: "They're a member of a gang",                        type: 'text' },
      { range: [6,  6],  text: "They're a government employee",                     type: 'text' },
      { range: [7,  7],  text: 'NCPD employee',                                     type: 'text' },
      { range: [8,  8],  text: 'News/entertainment professional',                   type: 'text' },
      { range: [9,  9],  text: 'Nomad pack member',                                 type: 'text' },
      { range: [10, 10], text: 'Retail employee',                                   type: 'text' },
    ],
  },

  // ── Roll ALL Lifepath ─────────────────────────────────────────────────────────
  // Formula 1d1 with all results on range [1,1] means every result fires every roll.
  // Document results reference the compendium tables which chain their sub-tables.

  {
    _id: 'GenLp00000000000',
    name: 'Roll ALL Lifepath',
    ...
    displayRoll: false,
    results: [
      { range: [1, 1], type: 'document', documentUuid: 'Compendium.cyberpunk-blue.lifepath-tables.RollTable.GenLp01000000000', text: 'Cultural Origins' },
      { range: [1, 1], type: 'document', documentUuid: 'Compendium.cyberpunk-blue.lifepath-tables.RollTable.GenLp02000000000', text: 'Your Family Background' },
      { range: [1, 1], type: 'document', documentUuid: 'Compendium.cyberpunk-blue.lifepath-tables.RollTable.GenLp03000000000', text: 'Childhood Environment' },
      ...
      { range: [1, 1], type: 'document', documentUuid: 'Compendium.cyberpunk-blue.lifepath-tables.RollTable.GenLp12000000000', text: 'Friends' },
      { range: [1, 1], type: 'document', documentUuid: 'Compendium.cyberpunk-blue.lifepath-tables.RollTable.GenLp13000000000', text: 'Enemies' },
      { range: [1, 1], type: 'document', documentUuid: 'Compendium.cyberpunk-blue.lifepath-tables.RollTable.GenLp14000000000', text: 'Your tragic love affair' },
    ],
  },
