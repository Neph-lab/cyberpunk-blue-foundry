...
const attachments = [
  ...
  modItem({ name: 'Tsunami Hakatome', manufacturer: 'Tsunami Arms', cost: 'EX', imgPath: img(M_ROOT, 'Tsunami Hakatome.png'),
    ...
    description: desc('Stock Mod for 1-hand firearms. Steady: +1 attack if user did not Move this turn. Shoulder Stock: now requires 2 hands; cannot conceal; uses Shoulder Arms skill.') }),
