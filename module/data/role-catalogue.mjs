...
<p><strong>Tough</strong> is a limited-use active ability (once + once per 3 full ranks). When activated: ignore wound-state penalties for 1 minute, heal 1 HP, take 2 less damage from Critical Injuries, and take 2 instead of 5 from Foreign Object.</p>`,
  abilitySections: [
    { id: id('bandit-1'), unlockRank: 1, content: '<p><strong>Tough</strong> — Activate to ignore wound penalties for 1 minute, heal 1 HP, and reduce Critical Injury damage by 2 (Foreign Object: 2 instead of 5). Uses: 1 + 1 per 3 full ranks; refresh on natural healing rest.</p><p><strong>Initiate</strong> — You have not proven yourself enough to boss others around, but attempting it is good practice.</p>' },
    { id: id('bandit-3'), unlockRank: 3, content: '<p><strong>Thug</strong> — After a successful facedown, fresh recruits follow your orders as long as they think you can check up on them. They still will not risk their lives or the lives of loved ones.</p>' },
    { id: id('bandit-5'), unlockRank: 5, content: '<p><strong>Ganger</strong> — Low-level thugs follow your orders if they have no reason not to, but will not risk their lives without a successful facedown.</p>' },
    { id: id('bandit-7'), unlockRank: 7, content: '<p><strong>Lieutenant</strong> — Newer members follow your orders unquestioningly. After a successful facedown, seasoned thugs or a specialist will do a job for you.</p>' },
    { id: id('bandit-9'), unlockRank: 9, content: '<p><strong>The Boss</strong> — You are part of the leadership or the top honcho. Only those in positions of power would question your orders. This power requires maintaining the gang — neglect it at your peril.</p>' },
  ],
...
<p>Replacing a lost team member (killed, disloyal, or dismissed) costs €$200.</p>`,
  abilitySections: [
    { id: id('corpo-1'), unlockRank: 1, content: '<p><strong>Signing Benefits</strong> — You are granted business-wear jacket, top, bottom, and footwear to signify your position.</p>' },
    { id: id('corpo-2'), unlockRank: 2, content: '<p><strong>Housing Benefits</strong> — You are given rent-free housing in a corporate conapt.</p>' },
    { id: id('corpo-3'), unlockRank: 3, content: '<p><strong>Teamwork</strong> — You are granted a subordinate as a team member. Choose from the NPC Actors attached to this Leader Role. A copy is given to you with Owner permission.</p>' },
    { id: id('corpo-5'), unlockRank: 5, content: '<p><strong>Human Resources</strong> — Your team is expanded with an additional subordinate of your choice.</p>' },
    { id: id('corpo-6'), unlockRank: 6, content: '<p><strong>Corporate Health Insurance</strong> — Your corporation pays for a Gold subscription to Trauma Team. You may pay the difference for Platinum.</p>' },
    { id: id('corpo-7'), unlockRank: 7, content: '<p><strong>Better Housing</strong> — Your provided housing is now a Beaverville style house.</p>' },
    { id: id('corpo-8'), unlockRank: 8, content: '<p><strong>Better Health Insurance</strong> — Your company\'s coverage is increased to Trauma Team Platinum.</p>' },
    { id: id('corpo-9'), unlockRank: 9, content: '<p><strong>Leadership</strong> — You gain a third subordinate at your disposal as part of your team.</p>' },
    { id: id('corpo-10'), unlockRank: 10, content: '<p><strong>Executive Accommodations</strong> — You are provided a mansion-style villa or luxury penthouse.</p>' },
  ],
  leaderFeatures: [
    {
...
<li><strong>Grease:</strong> Increasing understanding of the cultures around you. Gain Language ability ranks.</li>
  ...
  abilitySections: [
    { id: id('fixer-1'), unlockRank: 1, content: '<p><strong>First Contact</strong> — <em>Contacts:</em> Local honcho, gang lord, neighborhood leadership. <em>Reach:</em> Cheap (€$10) and Everyday (€$20), even if normally unavailable. <em>Haggle:</em> On success, push price up to 10% from market value. <em>Grease:</em> You know the ins-and-outs of your immediate neighborhood, including all local gangs.</p>' },
    { id: id('fixer-3'), unlockRank: 3, content: '<p><strong>Well Connected</strong> — <em>Contacts:</em> City gang honcho, minor politician, or someone well-known in the neighborhood. <em>Reach:</em> Expensive (€$50). <em>Haggle:</em> When you buy 5+ items, get one additional for free. <em>Grease:</em> Insights into a specific local culture. Gain one rank in a Language ability.</p>' },
    { id: id('fixer-5'), unlockRank: 5, content: '<p><strong>District Fixer</strong> — <em>Contacts:</em> Major City Player, city politico, neighborhood celebrity. <em>Reach:</em> Once per month help set up a Night Market; can source up to Super Luxury (€$10,000) items. <em>Haggle:</em> On success, negotiate job pay up to 20% per person. <em>Grease:</em> Well versed in 3 cultures total. Gain another Language rank.</p>' },
    { id: id('fixer-7'), unlockRank: 7, content: '<p><strong>Center of the Web</strong> — <em>Contacts:</em> Local corp president, mayor, local celebrity. <em>Reach:</em> Expensive (€$500). <em>Haggle:</em> On success, when buying Luxury (€$5,000) or Super Luxury (€$10,000), pay half now and the rest after a month. <em>Grease:</em> Blend in perfectly in 6+ cultures. Gain another Language rank.</p>' },
    { id: id('fixer-9'), unlockRank: 9, content: '<p><strong>Monarch of the Fixers</strong> — <em>Contacts:</em> Divisional corp head, state politico, well-known celebrity. <em>Reach:</em> Luxury (€$5,000). Night Markets can include a Midnight Market. <em>Haggle:</em> Adjust any item price by up to 20%. Gain another Language rank.</p>' },
    { id: id('fixer-10'), unlockRank: 10, content: '<p><strong>World Broker</strong> — <em>Contacts:</em> Major world leaders, major corporation heads, world celebrities. <em>Reach:</em> Almost any item. <em>Haggle:</em> Negotiate up to double pay per person for dangerous jobs. Repeat Language rank selection twice.</p>' },
  ],
...
<p>Cyberware interferes with your ability. When dealing a new Reading, first remove one card from the deck for each full 10 your max PSYCHE is below 60. These cards are locked until PSYCHE recovers.</p>`,
  abilitySections: [
    { id: id('guide-tarot'), unlockRank: 1, content: `<table><thead><tr><th>Card</th><th>Name</th><th>Meaning</th><th>Trigger</th><th>Effect</th></tr></thead><tbody>
...
<li><em>What crime did we fail to solve together?</em></li>
  ...
  abilitySections: [
    { id: id('law-1'), unlockRank: 1, content: '<p><strong>Corporate Security</strong> — DV 7. Four rent-a-cops arriving on foot. CombatN 8, SP 7, MOVE 5. Gear: Militech M-10AF Lexington, Flashlight, Radio. Cyberware: Neuroport.</p>' },
    { id: id('law-3'), unlockRank: 3, content: '<p><strong>Beat Cops</strong> — DV 9. Four local cops in two compact cars. CombatN 10, SP 7, MOVE 5. Gear: Militech M-10AF Lexington, Flashlight, Handcuffs, Radio, Road Flare. Cyberware: Neuroport.</p>' },
    { id: id('law-5'), unlockRank: 5, content: '<p><strong>Precinct Officers</strong> — DV 11. Two officers in a high-performance car. CombatN 12, SP 13. Gear: Militech M-76E Omaha, Arasaka Nowaki, Flashlight, Handcuffs ×2, Radio, Road Flare ×2. Cyberware: Neuroport.</p>' },
    { id: id('law-8'), unlockRank: 8, content: '<p><strong>SWAT</strong> — DV 14. One expert officer on a motorcycle. CombatN 14, SP 15, MOVE 5, BODY 7. Gear: Arasaka JKE-X2 Kenshin, Militech M362s Ajax (with mods), Stun Baton, Anti-Smog Mask, Handcuffs ×2, Radio, Road Flare ×2, Rope, Chipware: Pain Editor. Cyberware: Neuroport, Self-ICE, Kerenzikov, Cybereyes ×2 Wide-Spectrum, Cyberarm, Subdermal Grip.</p>' },
    { id: id('law-9'), unlockRank: 9, content: '<p><strong>MaxTac</strong> — DV 16. Two heavy-hitters from the cyberpsycho squad in an AV-4. CombatN 15, SP 18, MOVE 4, BODY 8. Gear: Techtronica RT-46 Burya, Arasaka HJSH-18 Masamune, Arasaka Dojigiri Yatsuna, Pain Editor. Cyberware: Neuroport, Self-ICE, Sandevistan, MultiOptic Mount, Cybereyes ×4 (full), Cyberarms ×2, Mantis Blades ×2, Subdermal Grip, Nasal Filters.</p>' },
    { id: id('law-10'), unlockRank: 10, content: '<p><strong>International Special Agents</strong> — DV 18. National law enforcement / Interpol / Netwatch pairs in an AV-4. They stay after the fact and aid in the investigation. Handled entirely by the GM.</p>' },
  ],
  leaderFeatures: [
...
<p>When you publish a story, roughly 10% of your audience believes your premise (+5% per rank +5% per verifiable fact, max 20% bonus).</p>`,
  abilitySections: [
    { id: id('media-1'), unlockRank: 1, content: '<p><strong>Aspiring Reporter</strong> — <em>Access:</em> Local honcho, gang lord, neighborhood leadership. <em>Audience:</em> Your immediate neighborhood. <em>Impact:</em> Minor actors in the space might shift their ways.</p>' },
    { id: id('media-3'), unlockRank: 3, content: '<p><strong>Journalist</strong> — <em>Access:</em> City gang honcho, minor politician, well-known person in the neighborhood. <em>Audience:</em> Well-known contributor to the local screamsheet or Data Pool. <em>Impact:</em> Small-timers get arrested or thrown out of power.</p>' },
    { id: id('media-5'), unlockRank: 5, content: '<p><strong>Intrepid Investigator</strong> — <em>Access:</em> Major city player, city politico, local celebrity. <em>Audience:</em> City-wide; regular columnist or contributor. <em>Impact:</em> Changes things across the city; higher-level targets may be jailed.</p>' },
    { id: id('media-7'), unlockRank: 7, content: '<p><strong>Seasoned Journalist</strong> — <em>Access:</em> Local corp president, mayor, city celebrity. <em>Audience:</em> State-wide; you are a minor celebrity. <em>Impact:</em> Change spreads across multiple cities; mid-level corps or governments may fall.</p>' },
    { id: id('media-9'), unlockRank: 9, content: '<p><strong>Senior Correspondent</strong> — <em>Access:</em> Divisional corp head, state politico, well-known celebrity. <em>Audience:</em> Continent-wide within your area of expertise. <em>Impact:</em> Can topple large corporations or local governments.</p>' },
    { id: id('media-10'), unlockRank: 10, content: '<p><strong>World Journalist</strong> — <em>Access:</em> Major world leaders, corporation heads, world celebrities. <em>Audience:</em> World-wide; both celebrity and go-to leak recipient. <em>Impact:</em> Large-scale changes affecting millions.</p>' },
  ],
...
<p>To get fans to do things: roll 1d10 + COOL + Rocker ranks. Individual: DV 15. Small group (≤20): DV 18. Large group (≤100): DV 22. +1 per rank above needed.</p>`,
  abilitySections: [
    { id: id('rocker-1'), unlockRank: 1, content: '<p><strong>Enthusiast</strong> — <em>Venues:</em> Small local clubs. <em>Single Fan:</em> Small favor (buy a drink, give a lift). <em>Small Group:</em> Ask for autographs; stop you in streets to befriend. <em>Large Group:</em> Not yet.</p>' },
    { id: id('rocker-3'), unlockRank: 3, content: '<p><strong>Promising Artist</strong> — <em>Venues:</em> Well-known clubs. <em>Single Fan:</em> Major favor (go to bed, put in a good word). <em>Small Group:</em> Fans regularly hang out, provide party favors. <em>Large Group:</em> Strong local following; fans buy recordings and merch.</p>' },
    { id: id('rocker-5'), unlockRank: 5, content: '<p><strong>Rising Star</strong> — <em>Venues:</em> Large, important clubs. <em>Single Fan:</em> Commit a minor crime (shoplift, fight). <em>Small Group:</em> Personal "posse"; constantly hang out, provide what you need. <em>Large Group:</em> Fans all over the city and nearby cities; strongly loyal.</p>' },
    { id: id('rocker-7'), unlockRank: 7, content: '<p><strong>True Star-Power</strong> — <em>Venues:</em> Small concert halls, local video feed. <em>Single Fan:</em> Risk their life without question. <em>Small Group:</em> Commit minor crimes. <em>Large Group:</em> Rabidly loyal; fight rival fan groups, support info networks, band together to help.</p>' },
    { id: id('rocker-9'), unlockRank: 9, content: '<p><strong>Scream and the World Will Listen</strong> — <em>Venues:</em> Large concert halls, national video feed. <em>Single Fan:</em> Commit major crimes. <em>Small Group:</em> Commit major crimes. <em>Large Group:</em> Brainwashed, cult-like; will riot, destroy property, even kill for you.</p>' },
    { id: id('rocker-10'), unlockRank: 10, content: '<p><strong>Worldwide Icon</strong> — <em>Venues:</em> Huge stadiums or international video. <em>Single Fan:</em> Sacrifice themselves without question. <em>Small Group:</em> Risk their lives; act as personal protection. <em>Large Group:</em> Worldwide cult-like following; private army based on your charisma.</p>' },
  ],
