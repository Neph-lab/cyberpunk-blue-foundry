...
<li><em>What crime did we fail to solve together?</em></li>
  ...
  leaderFeatures: [
    { id: id('law-feat-corpsec'), unlockRank: 1, name: 'Corporate Security', description: 'Roll <strong>1d10</strong> + Role rank vs <strong style="color: var(--cpb-accent);">DV 7</strong> to call in four Corporate Security officers on foot.', selectionCount: 1, permission: 'observer', options: [], selectedUuids: [] },
    { id: id('law-feat-beatcops'), unlockRank: 3, name: 'Beat Cops', description: 'Roll <strong>1d10</strong> + Role rank vs <strong style="color: var(--cpb-accent);">DV 9</strong> to call in four beat cops in two compact cars.', selectionCount: 1, permission: 'observer', options: [], selectedUuids: [] },
    { id: id('law-feat-precinct'), unlockRank: 5, name: 'Precinct Officers', description: 'Roll <strong>1d10</strong> + Role rank vs <strong style="color: var(--cpb-accent);">DV 11</strong> to call in two precinct officers in a high-performance car.', selectionCount: 1, permission: 'observer', options: [], selectedUuids: [] },
    { id: id('law-feat-swat'), unlockRank: 8, name: 'SWAT', description: 'Roll <strong>1d10</strong> + Role rank vs <strong style="color: var(--cpb-accent);">DV 14</strong> to call in one SWAT officer on a motorcycle.', selectionCount: 1, permission: 'observer', options: [], selectedUuids: [] },
    { id: id('law-feat-maxtac'), unlockRank: 9, name: 'MaxTac', description: 'Roll <strong>1d10</strong> + Role rank vs <strong style="color: var(--cpb-accent);">DV 16</strong> to call in two MaxTac operators in an AV-4.', selectionCount: 1, permission: 'observer', options: [], selectedUuids: [] },
  ],
      ...
      optionGroups: [
        {
          ...
          options: [
            ...
            { id: id('medtech-drug-antipsychosis'), name: 'Anti-Psychosis', description: 'Restores <strong>1d6</strong> PSYCHE. One dose per week.' },
            { id: id('medtech-drug-myelin'), name: 'Myelin Strengthener', description: '<strong>+1</strong> <strong>RFLX</strong> for <strong>2d6</strong> hours. One dose per day.' },
            { id: id('medtech-drug-rapidetox'), name: 'Rapidetox', description: 'Immediately purges any drug, poison, or intoxicant.' },
            { id: id('medtech-drug-roids'), name: 'Roids', description: '<strong>+1</strong> <strong>BODY</strong> for <strong>2d6</strong> hours. One dose per day.' },
            { id: id('medtech-drug-runnerspeed'), name: 'Runnerspeed', description: '<strong>+1</strong> NET Action per round for 1 hour (if the target can perform NET actions).' },
            { id: id('medtech-drug-speedheal'), name: 'Speedheal', description: 'Heal HP equal to <strong>BODY</strong> (target not <strong>Mortally Wounded</strong>). One dose per day.' },
            { id: id('medtech-drug-stim'), name: 'Stim', description: 'Ignore <strong>Seriously Wounded</strong> penalties for 1 hour; reduce critical-consequence damage by up to 1 HP/round. One dose per day.' },
            { id: id('medtech-drug-surge'), name: 'Surge', description: 'No need for sleep for 24 hours. One dose per week.' },
            { id: id('medtech-drug-torpor'), name: 'Torpor', description: 'Fall unconscious for <strong>2d6</strong> hours (<strong style="color: var(--cpb-accent);">DV 15</strong> <strong>Medicine</strong> to detect vital signs). An antidote is also produced.' },
          ],
          selectedOptionIds: [],
        },
      ],
...
<li><em>What secret have you asked me to keep?</em></li>
  ...
  abilitySections: [],
  proteanFoci: [
    { id: id('ninja-tac-poison'), unlockRank: 1, name: 'Poison', description: 'Apply a toxin to a Melee Weapon. When you attack and penetrate SP at all, the target makes a <strong>BODY</strong> + <strong>Endurance</strong> check at <strong style="color: var(--cpb-accent);">DV = 11 + points allocated</strong>. On failure, take <strong>1d6</strong> additional direct HP damage.', minPoints: 0, maxPoints: 10, step: 1, points: 0 },
    { id: id('ninja-tac-silent'), unlockRank: 1, name: 'Silent Death', description: 'Each point allocated gives <strong>+1</strong> to <strong>Stealth</strong> checks.', minPoints: 0, maxPoints: 10, step: 1, points: 0 },
    { id: id('ninja-tac-threat'), unlockRank: 1, name: 'Threat Detection', description: 'Each point allocated gives <strong>+1</strong> to <strong>Perception</strong> checks. Does not stack with the same tactic from the Solo Role.', minPoints: 0, maxPoints: 10, step: 1, points: 0 },
    { id: id('ninja-tac-martial'), unlockRank: 2, name: 'Martial Skill', description: '<strong>+1</strong> to Melee Weapon and <strong>Martial Arts</strong> attacks for every 2 points allocated (max <strong>+3</strong> for 6 points).', minPoints: 0, maxPoints: 6, step: 1, points: 0 },
    { id: id('ninja-tac-cover'), unlockRank: 2, name: 'Seek Cover', description: 'Allocating 2 points gives <strong>+5</strong> to Initiative, but your first turn can only focus on hiding or retreating.', minPoints: 0, maxPoints: 2, step: 2, points: 0 },
    ...
    { id: id('ninja-tac-precision'), unlockRank: 3, name: 'Precision Kill', description: 'When your target is unaware of your attack: <strong>+1d6</strong> damage for 3 points, <strong>+2d6</strong> for 6 points, <strong>+3d6</strong> for 9 points.', minPoints: 0, maxPoints: 9, step: 3, points: 0 },
  ],
      ...
      optionGroups: [
        {
          ...
          options: [
            ...
            { id: id('op-strat-badge'), name: 'Badge', description: 'Quickly reproduce a group symbol as a replica (€$50 materials). Those normally using the badge have <strong>+2</strong> to see through it.' },
      ...
      optionGroups: [
        {
          ...
          options: [
            ...
            { id: id('op-cover-convincing'), name: 'Convincing Training', description: '<strong>+2</strong> on <strong>Acting</strong> tests to perform your cover convincingly. Can be taken up to 5 times per cover.' },
            ...
            { id: id('op-cover-faceplate'), name: 'Faceplate', description: 'Cover gets its own appearance via cybernetics and body-sculpting (10 min to switch). Others take 30 min to change it. PSYCHE loss: 7 (<strong>2d6</strong>).' },
...
<li><em>Who did you know that died by my side in combat?</em></li>
  ...
  abilitySections: [],
  proteanFoci: [
    { id: id('solo-tac-init'), unlockRank: 1, name: 'Initiative Reaction', description: 'Each point allocated gives <strong>+1</strong> to Initiative.', minPoints: 0, maxPoints: 10, step: 1, points: 0 },
    { id: id('solo-tac-pummel'), unlockRank: 1, name: 'Pummel', description: '1 point: <strong>+1</strong> damage with <strong>Martial Arts</strong> (<strong>Brawling</strong>) when holding a weapon. 2 points: use any one-handed item as a Light Melee weapon, or two-handed as a Medium Melee weapon.', minPoints: 0, maxPoints: 2, step: 1, points: 0 },
    { id: id('solo-tac-spot'), unlockRank: 1, name: 'Spot Weakness', description: 'Each point allocated gives <strong>+1</strong> damage (before armor) to your first successful attack each round.', minPoints: 0, maxPoints: 10, step: 1, points: 0 },
    { id: id('solo-tac-threat'), unlockRank: 1, name: 'Threat Detection', description: 'Each point allocated gives <strong>+1</strong> to <strong>Perception</strong> checks. Cannot stack with the same tactic from the Ninja Role.', minPoints: 0, maxPoints: 10, step: 1, points: 0 },
    { id: id('solo-tac-deflect'), unlockRank: 2, name: 'Damage Deflection', description: 'For every 2 points allocated, reduce the first damage you take each round by 1 (max <strong>−5</strong> at 10 points).', minPoints: 0, maxPoints: 10, step: 2, points: 0 },
    { id: id('solo-tac-precision'), unlockRank: 3, name: 'Precision Attack', description: '<strong>+1</strong> to all attacks for every 3 points allocated (max <strong>+3</strong> for 9 points).', minPoints: 0, maxPoints: 9, step: 3, points: 0 },
      ...
      optionGroups: [
        {
          ...
          choices: 10,
          options: [
            { id: id('tech-upg-psyche'), name: 'Lower PSYCHE Loss', description: 'Lower PSYCHE loss from non-borgware by <strong>1d6</strong> (or 4, chosen at start). Only if typical loss is 7+.' },
