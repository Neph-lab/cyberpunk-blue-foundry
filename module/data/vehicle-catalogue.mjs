...
export const VEHICLE_CATALOGUE = [
...

  {
    ...
    system: {
      ...
      description: 'This is a compact civilian vehicle. It is fast and nimble, but only lightly armored.',
      notes: NOTES,
    },
  },

  {
    ...
    system: {
      ...
      description: 'This is a heavy cargo and transport vehicle. It is very tough, but slow to maneuver.',
      notes: NOTES,
    },
  },
...

  {
    ...
    system: {
      ...
      description: 'This is an armed rotary-wing aircraft. It is fast and well armed, but fragile compared to ground armor.',
      notes: NOTES,
    },
  },
];
